    ...
    with torch.no_grad():
        ...
        for i, (input, target, target_weight, meta) in enumerate(val_loader):
            ...
            if config.TEST.FLIP_TEST:
                ...
                input_flipped = torch.from_numpy(input_flipped).to(device, non_blocking=True)
                ...
                output_flipped = torch.from_numpy(output_flipped.copy()).to(device, non_blocking=True)
